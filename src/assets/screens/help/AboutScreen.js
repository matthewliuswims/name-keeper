      ...
      <View style={container}>
        <ScrollView>
          <View style={styles.HeaderQuestion}>
            <Text style={styles.headerQuestionText}>What is {nameOfApp} for? tldr; </Text>
          </View>
          <Text style={styles.AnswerText}>How often do you remember someone&apos;s face, but not their name? This app offers a solution. </Text>
          <View style={styles.HeaderQuestion}>
            <Text style={styles.headerQuestionText}>Why should I use {nameOfApp}?</Text>
          </View>
          ...
          <Text style={styles.AnswerText}><Text style={{ fontWeight: 'bold' }}> 6. </Text> No fear: using {nameOfApp} you are able to quickly see that girl&apos;s name. </Text>
